...
import sty from "./PlasmicButton.module.css"; // plasmic-import: hPfwKOhVavMYd/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: wu8m2k0TA3mqbk/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__girNn)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mzBie)}
                role={"img"}
              />
            ),
