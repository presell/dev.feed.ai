...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: neqq7VcKj83JDW/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: rgJ1Zd66sbG2bP/icon
  ...
  const stateSpecs = React.useMemo(
    () => [
      ...
      },
      {
        path: "small",
        type: "private",
        initFunc: ($props, $state, $ctx) => $props.small
      }
    ],
    [$props, $ctx]
  );
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__oiaYj)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__jFg7)}
                role={"img"}
              />
            ),
